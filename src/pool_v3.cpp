...
void Pool::ControlBlock::CreateParent (ControlBlock* left) {

    total_amount_of_water_ += left->total_amount_of_water_;
    count_of_pools_ += left->count_of_pools_;
    reference_count_ += left->reference_count_;
